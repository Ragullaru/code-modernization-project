...
const ModalMenuSliderPage = () => {
  ...
  // Close navbar when clicking outside of it and the toggle button
  useEffect(() => {
    if (!isNavOpen) return;
    ...
    const handleDocumentClick = (e: MouseEvent) => {
      ...
      if (!target || !navRef.current || !toggleRef.current) return;
  ...
  return (
    <>
      {/* Main wrapper so we can add the show-nav class on the root */}
      <div className={isNavOpen ? "show-nav page-root" : "page-root"}>
        {/* Side Navigation */}
        ...
        {/* Page Content (slides when nav opens) */}
        <div className="page-content">
          <header>
            ...
            <button className="cta-btn" id="open" onClick={handleOpenModal}>
              Sign Up
            </button>
          </header>
      ...
      {/* Global styles ported and slightly adapted from original style.css */}
      <style jsx global>{`
        ...
        * {
        ...
        /* Include Font Awesome link globally via _app or layout if you want,
           but the classes will work as soon as that CSS is loaded. */
...
export default ModalMenuSliderPage;
